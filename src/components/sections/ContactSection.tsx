...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-obsidian min-h-[calc(100dvh-3.5rem)] flex items-center py-20 scroll-mt-14">
      <div className="max-w-[1500px] mx-auto w-full px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[9_11] gap-12 mt-6">
          ...
          <div className="bg-white/4 border border-white/10 rounded-[24px] p-6">
            <form
